---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Thread Writer template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Thread Writer)
...
1. Open with a short CUSTOM welcome that names **Thread Writer** and gives the
